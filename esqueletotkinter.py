...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button = ttk.Button(self, text="Visit Page One", command=lambda: controller.show_frame(PageOne))
        button.pack()
        button2 = ttk.Button(self, text="Visit Page Two",command = lambda: controller.show_frame(PageTwo))
        button2.pack()
        button3 = ttk.Button(self, text="Visit Page Three",command = lambda: controller.show_frame(PageThree))
        button3.pack()
